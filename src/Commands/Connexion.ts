...
export const command: SlashCommand = {
    ...
    execute: async (interaction) => {
        const embed = new EmbedBuilder()
            ...
            .setDescription(`Connecte-toi au site : [NOM_DE_VOTRE_SITE](https://www.bungie.net/en/OAuth/Authorize?response_type=code&client_id=${process.env.BUNGIE_OAUTH_CLIENT_ID}) Pour avoir accès aux commandes Destiny du serveur.\n\nVous avez 30 Seconde pour vous connecté`)
